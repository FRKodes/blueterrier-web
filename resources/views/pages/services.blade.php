		...
		<div class="row">
			<div class="col-md-6 service-btn logo-design">
				<a href="#open-logo-design" class="open-extra-info white" data-open="logo-design">
					...
					<h2>Logo Design</h2>
					<p class="description">“From zero to Hero” We build logos which transcend and your target will love it.</p>
				</a>
			...
			<div class="col-md-6 service-btn design-adv">
				<a href="#open-design-adv" class="open-extra-info white" data-open="design-adv">
					...
					<p class="description">Product Labels, packaging, stationery, brochures, editorial… we will surprise you!</p>
				</a>
